...
import { Percent, TrendingUp, Euro, Shield } from 'lucide-react';
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      <HudPanel className="p-4">
        <div className="flex flex-col items-center text-center">
          <Euro className="w-6 h-6 text-plasma mb-1" />
          ...
          <div className="flex items-center justify-center gap-2 mb-2">
            <h3 className="mono text-gray-400 text-xs uppercase tracking-wider">FUNDING PROGRESS</h3>
            <Euro className="w-5 h-5 text-plasma" />
          </div>
