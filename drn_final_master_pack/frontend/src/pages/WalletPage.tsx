      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <div className="flex-1 p-6 lg:p-8 overflow-y-auto">
          <div className="max-w-7xl mx-auto">
            ...
            <HudPanel className={`p-6 mb-8 ${user?.kyc_status !== 'approved' ? 'opacity-50 pointer-events-none' : ''}`}>
              {walletError && (
            ...
            {/* Transaction History */}
            {walletAddress && (
              <div className={user?.kyc_status !== 'approved' ? 'opacity-50 pointer-events-none' : ''}>
                <TransactionHistory 
                walletAddress={walletAddress}
                userId={user?.id}
                isCorrectNetwork={isCorrectNetwork}
