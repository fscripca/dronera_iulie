      ...
      <div className="container mx-auto">
        ...
        <div className="flex justify-center mb-16">
          <div className="flex space-x-4">
             ...
             <button
              className={`flex items-center space-x-2 py-3 px-6 rounded-lg transition-colors ${
                activeSection === 0 
                  ? 'bg-[#0a0a0f] border border-plasma text-plasma' 
        ...
        {/* Swarm AI Section */}
        <section ref={sectionRefs[2]} className="mb-32 scroll-mt-32">
              ...
              <HudPanel className="aspect-square" glowColor="red">
                <div className="absolute inset-0 overflow-hidden">
                  <img 
                    ...
                    className="w-full h-full object-cover object-center bg-black filter-none"
                  />
              ...
              <HudPanel className="aspect-square">
                <div className="absolute inset-0 overflow-hidden">
                  <img
                    ...
                    className="w-full h-full object-contain object-center brightness-110 contrast-110 filter-none"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0a0a0f] via-transparent to-transparent opacity-80"></div>
                </div>
                <div className="absolute bottom-6 left-6 right-6">
